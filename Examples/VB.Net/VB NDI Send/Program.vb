...
Class Program
	Private Shared Sub DrawPrettyText(graphics As Graphics, text As [String], size As Single, family As FontFamily, origin As Point, format As StringFormat, _
                        ...
                        Using graphics As Graphics = graphics.FromImage(bmp)
                            ...
                            For frameNumber As Integer = 0 To 9999
                                ...
                                Else
                                    ...
                                    DrawPrettyText(graphics, "VB Example Source", 96.0F, fontFamily, New Point(960, 100), textFormat, _
                                    ...
                                    If NDI_tally.on_program Then
                                        DrawPrettyText(graphics, "On Program", 96.0F, fontFamily, New Point(960, 225), textFormat, _
                                            Brushes.White, outlinePen)
                                    ElseIf NDI_tally.on_preview Then
                                        DrawPrettyText(graphics, "On Preview", 96.0F, fontFamily, New Point(960, 225), textFormat, _
                                            Brushes.White, outlinePen)
                                    End If

                                    '''/ show what frame we've rendered
                                    DrawPrettyText(graphics, [String].Format("Frame {0}", frameNumber.ToString()), 96.0F, fontFamily, New Point(960, 350), textFormat, _
                                        Brushes.White, outlinePen)

                                    ' show current time
                                    DrawPrettyText(graphics, System.DateTime.Now.ToString(), 96.0F, fontFamily, New Point(960, 900), textFormat, _
                                        Brushes.White, outlinePen)
