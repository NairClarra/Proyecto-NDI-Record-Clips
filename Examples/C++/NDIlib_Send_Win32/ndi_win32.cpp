...
{	// No HDC
	...
	*(FARPROC*)&bgrx_to_uyvy_cond = GetProcAddress(hLib, "bgrx_to_uyvy_cond");
	...
	NDI_send_create_desc.p_ndi_name = p_ndi_name;
...
{	// No previous bitmap
	...
	frame.frame_rate_N = m_framerate_n;
	frame.frame_rate_D = m_framerate_d;
	frame.p_data = changes ? m_p_uyvy : NULL;
	frame.line_stride_in_bytes = m_xres * 2;
