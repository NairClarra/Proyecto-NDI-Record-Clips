		...
		{	// Parse the XML
			...
			{	// Get the perser
				...
				{	// Get the values
					...
					if (!p_mode);
					else if (!::strcasecmp(p_mode->value(), "auto"))   mode = e_focus_mode_auto;
					else if (!::strcasecmp(p_mode->value(), "manual")) mode = e_focus_mode_manual;
					else;
				...
				{	// Get the values
					...
					enum e_white_balance_mode { e_white_balance_mode_auto, e_white_balance_mode_indoor, e_white_balance_mode_outdoor, 
												e_white_balance_mode_one_push, e_white_balance_mode_manual };

					// Get the auto-focus mode
					e_white_balance_mode mode = e_white_balance_mode_auto;
					if (!p_mode);
					else if (!::strcasecmp(p_mode->value(), "auto"))     mode = e_white_balance_mode_auto;
					else if (!::strcasecmp(p_mode->value(), "indoor"))   mode = e_white_balance_mode_indoor;
					else if (!::strcasecmp(p_mode->value(), "outdoor"))  mode = e_white_balance_mode_outdoor;
					else if (!::strcasecmp(p_mode->value(), "one_push")) mode = e_white_balance_mode_one_push;
					else if (!::strcasecmp(p_mode->value(), "manual"))   mode = e_white_balance_mode_manual;
					else;
					...
					if (mode == e_white_balance_mode_auto)
							...
							printf("Set white-balance into manual mode with red, blue = [ %1.2f, %1.2f ]\n",
				...
				{	// Get the values
					...
					if (!p_mode);
					else if (!::strcasecmp(p_mode->value(), "auto"))     mode = e_exposure_mode_auto;
					else if (!::strcasecmp(p_mode->value(), "manual"))   mode = e_exposure_mode_manual;
					else;
					...
					if (mode == e_exposure_mode_auto)
						...
						printf("Set exposure into manual mode with iris = %1.2f gain = %1.2f shutter speed = %1.2f\n",
